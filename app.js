            ...
            function(e, t, n) {
                ...
                if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(d))
                    for (r in (f &&
                            ...
                            d))
                        u ||
                        (v ? "hidden" in v && (g = v.hidden) : (v = Y.access(e, "fxshow", {
                                display: l
                            })),
                            o && (v.hidden = !g),
                            g && le([e], !0),
...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    $(".intTelInput").keyup(function() {
        ...
        if (contryCode == "") {
            ...
            $(":input[name=fullMobileNo]").val("+" + contryCode);
        }
    });
    var input_mob = $('#intTelInput-mob');
    input_mob.on('countrychange', function(e) {

        var contryCode = $("#intTelInput-mob").intlTelInput("getSelectedCountryData").dialCode;
        $('#country1').val("+" + contryCode);
    });
    var input_side = $('#intTelInput-side');
    input_side.on('countrychange', function(e) {

        var contryCode = $("#intTelInput-side").intlTelInput("getSelectedCountryData").dialCode;
        $('#country2').val("+" + contryCode);
    });
    var input_pop = $('#intTelInput-popup');
    input_pop.on('countrychange', function(e) {

        var contryCode = $("#intTelInput-popup").intlTelInput("getSelectedCountryData").dialCode;
        $('#country3').val("+" + contryCode);
    });
    var interval;
...
$(".enqModal").click(function() {
    ...
    var lead_form_name = $(this).data("title");
...
(ua = navigator.userAgent.toLowerCase()), (platform = navigator.platform.toLowerCase());
